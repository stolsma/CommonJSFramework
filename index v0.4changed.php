...
<p class="EditorNote">I've put the Registry and Repository store in this system but it could be argued to implement a seperate Registry and Repository System like Context/Package/Module Systems</p>
<p></p>
<p class="EditorNote">The next part of this chapter will be dedicated to describe the Functional requirements and APIs. Please give feedback how to incorporate Functional requirements in this document!! The API description can be better placed in the detailled specifications documents I think</p>
...
<div style="float:right; overflow:auto; margin: 10px 0px 10px 10px;"><a href="Specific Loader Functions Layer v0.4.png"><img src="Specific Loader Functions Layer v0.4.png" width="200" height="181" longdesc="Specific Loader Functions Layer in the Architecture" /></a></div>
			...
			<p class="EditorNote">How are Loader Plugins with Specific Loader Functions coupled with the Core CommonJS System (Loader API/Generic Loader Functions). Think of plugins being coupled from within modules or plugins coupled from the extra module environment i.e. basic global script code</p>
...
<div style="float:right; overflow:auto; margin: 10px 0px 10px 10px;"><a href="Transport Protocols Layer v0.4.png"><img src="Transport Protocols Layer v0.4.png" width="200" height="181" longdesc="Transport Protocols Layer in the Architecture" /></a></div>
			...
			<p class="EditorNote">Describe some basic Transport Protocols in a high level fashion. Details must be specified in specific Transport specification documents.<br />
			</p>
			<div class="Subkop">
				<p>Glossary</p></div>
			<p class="EditorNote">here all definitions need to be inserted. Please help with definitions!!!<br />
			</p>
<div class="Subkop">References</div>
	...
	<div id="Footer">
		...
		<div class="FooterAlgemeen">
			<div class="copyright">(c)1998-2009 SSMT. Last modified:<!-- #BeginDate format:En2m -->08-Feb-2011  12:18<!-- #EndDate --></div>
		</div>
	</div>
</div>
</body>
